...
文件窗口由文件列表、[文件夹标签](浏览/多文件夹/标签页/README.md)、状态栏、[工具栏](浏览/窗口/工具栏/README.md)、[文件夹树](浏览/导航/文件夹树.md)和其它窗格组成。除了必须保留一个文件列表外，文件窗口中的所有其它组件都可移除。
...
查找 | [过滤](浏览/查看/列表/即时查找.md#过滤--过滤器栏) | 选择 | 范围
--- | --- | --- | ---
